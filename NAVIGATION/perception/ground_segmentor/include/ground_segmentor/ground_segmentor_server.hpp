#ifndef GROUND_SEGMENTOR__GROUND_SEGMENTOR_SERVER_HPP_
#define GROUND_SEGMENTOR__GROUND_SEGMENTOR_SERVER_HPP_
...
{
    using PluginPtr = std::shared_ptr<GroundSegmentorBase>;

    class GroundSegmentorServer : public rclcpp_lifecycle::LifecycleNode
    {
        public:
            explicit GroundSegmentorServer(const rclcpp::NodeOptions & options = rclcpp::NodeOptions());
        ...
        private:
            std::shared_ptr<pluginlib::ClassLoader<GroundSegmentorBase>> plugin_loader_;
            ...
            */
            ...
            // 插件实例名
            std::vector<std::string> ground_segmentor_plugin_ids_;
...
#endif  // GROUND_SEGMENTOR__GROUND_SEGMENTOR_SERVER_HPP_
