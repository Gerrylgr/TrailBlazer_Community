#ifndef GLOBAL_PLANNER__GLOBAL_PLANNER_SERVER_HPP_
#define GLOBAL_PLANNER__GLOBAL_PLANNER_SERVER_HPP_
...
{
    using PluginPtr = std::shared_ptr<GlobalPlannerBase>;

    class GlobalPlannerServer : public rclcpp_lifecycle::LifecycleNode
    {
        public:
            explicit GlobalPlannerServer(const rclcpp::NodeOptions & options = rclcpp::NodeOptions());
        ...
        private:
            std::shared_ptr<pluginlib::ClassLoader<GlobalPlannerBase>> plugin_loader_;
            ...
            */
            ...
            // 插件实例名
            std::vector<std::string> global_planner_plugin_ids_;
...
#endif  // GLOBAL_PLANNER__GLOBAL_PLANNER_SERVER_HPP_