#ifndef LOCAL_PLANNER__LOCAL_PLANNER_SERVER_HPP_
#define LOCAL_PLANNER__LOCAL_PLANNER_SERVER_HPP_
...
{
    using PluginPtr = std::shared_ptr<LocalPlannerBase>;

    class LocalPlannerServer : public rclcpp_lifecycle::LifecycleNode
    {
        public:
        ...
        private:
            std::shared_ptr<pluginlib::ClassLoader<LocalPlannerBase>> plugin_loader_;
            ...
            */
            ...
            // 插件实例名
            std::vector<std::string> local_planner_plugin_ids_;
...
#endif  // LOCAL_PLANNER__LOCAL_PLANNER_SERVER_HPP_